...
<script src="https://kit.fontawesome.com/ea08f13efd.js" crossorigin="anonymous"></script>
...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          <h2><strong>Sign up to CRM</strong></h2>
          <p>            <a href="login.php">Sign in Now!</a> for a webarch account,It's free and always will be..</p>
          <br>
           <img src="./assets/img/user.png" alt="" style="width: 300px; height:300px; margin-top: 10%;">
