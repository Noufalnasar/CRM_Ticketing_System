...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <!-- <script src="https://kit.fontawesome.com/d223bcd119.js" crossorigin="anonymous"></script> -->
...
<div class="container mt-5 mr-5" >
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1 mt-5">
          <h2>Sign in to CRM ADMIN</h2>
          <p>
            <a href="registration.php">Sign in Now!</a> for a webarch account,It's free and always will be..</p>
          <br>

		   
        </div>
        <div class="col-md-5 mt-5" > <br>
             <p style="color:#F00"><?php echo $_SESSION['action1'];?><?php echo $_SESSION['action1']="";?></p>
		 <form id="login-form" class="login-form mt-5"  action="" method="post">
		 <div class="row">
		 <div class="form-group col-md-10">
            ...
            <div class="controls">
				<div class="input-with-icon  right">                                       
					<i class=""></i>
					<input type="text" name="email" id="txtusername" class="form-control" required="true">                                 
				</div>
            </div>
          </div>
          </div>
